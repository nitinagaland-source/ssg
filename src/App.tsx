...
const NotFoundPage: React.FC = () => (
  <div className="max-w-7xl mx-auto px-4 py-24 text-center space-y-4">
    ...
    <h1 className="text-3xl font-extrabold font-display text-[#0A0A0A]">
      Page Not Found
    </h1>
    <p className="text-sm text-[#6B6B6B] max-w-sm mx-auto">
      The page you were looking for doesn&apos;t exist or was moved to another shelf.
    </p>
    <div className="pt-2">
      <Link
        to="/"
        className="inline-flex items-center gap-2 bg-[#0A0A0A] text-white px-6 py-3 rounded-full text-xs font-semibold hover:bg-[#FF5A1F] transition-colors"
      >
        Return to Homepage
      </Link>
    </div>
